...
import {_PlayIcon, QueueListIcon} from '@heroicons/react/24/outline';
      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex flex-col sm:flex-row items-start md:items-center space-y-3 sm:space-y-0 sm:space-x-4 mb-3">
          ...
          <div className="flex-grow">
            ...
            >
              <QueueListIcon className="w-3.5 h-3.5 mr-1" /> Edit details
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3 mt-4">
          ...
          >
            <QueueListIcon className="w-5 h-5 mr-2 transform scale-x-[-1]" />
            Shuffle
          </button>
        </div>
      </div>
                ...
                {activeVideoMenuId === video.id && (
                  ...
                  >
                    <button
                      ...
                      role="menuitem"
                    >
                      <QueueListIcon className="w-4 h-4 mr-2.5" />
